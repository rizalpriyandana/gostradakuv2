...
class RequestSuratController extends GetxController {
  ...
  getSurat() async {
    var response = await http.post(Uri.parse(
        "https://siakadtest.strada.ac.id/mobile/request_surat/list_surat"));
  ...
  generateinputsurat(String id_jenis_surat) async {
    ...
    var response = await http.post(
        Uri.parse(
            "https://siakadtest.strada.ac.id/mobile/request_surat/get_input_surat"),
        body: dataBody);
  ...
  sendsurat(Map<String, String> dataBody) async {
    var response = await http.post(
        Uri.parse(
            "https://siakadtest.strada.ac.id/mobile/request_surat/save_surat"),
        body: dataBody);
  ...
  historysurat(String nim) async {
    ...
    var response = await http.post(
        Uri.parse(
            "https://siakadtest.strada.ac.id/mobile/request_surat/riwayat_surat"),
        body: dataBody);
  ...
  detailhistorysurat(String nim, String nomor_surat) async {
    ...
    var response = await http.post(
        Uri.parse(
            "https://siakadtest.strada.ac.id/mobile/request_surat/detail_surat"),
        body: dataBody);
  ...
  Future downloadsurat(Dio dio, String? nim, String nomor_surat, String place,
    ...
    var response = await http.post(
        Uri.parse(
            "https://siakadtest.strada.ac.id/mobile/request_surat/unduh_surat"),
        body: dataBody);
