...
import 'package:gostradav2/app/data/models/periode_m.dart';
import 'package:gostradav2/app/data/models/softskill/editsoftskill_m.dart';
import 'package:gostradav2/app/data/models/softskill/softskill_m.dart';
import 'package:gostradav2/app/data/models/test_m.dart';
...
class SoftSkillController extends GetxController {
  ...
  listdata(String nim) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/nonakademik/list_data"),
        body: dataBody);
  ...
  inputdata(String nim, String idPeriode, String name, String date, String note, String nilaiangka, String nilaihuruf, files) async {
    ...
    var request = http.MultipartRequest('POST',
        Uri.parse('https://siakadtest.strada.ac.id/mobile/nonakademik/save'));
  ...
  updatedata(String id, String nim, String idPeriode, String name, String date, String note, String nilaiangka, String nilaihuruf, files) async {
    ...
    var request = http.MultipartRequest('POST', Uri.parse("https://siakadtest.strada.ac.id/mobile/nonakademik/update"));
    request.fields.addAll({
      'id': id,
      'nim': nim,
      'id_periode': idPeriode,
  ...
  delete(String id) async{
    ...
    var response = await http.post(Uri.parse("https://siakadtest.strada.ac.id/mobile/nonakademik/delete"),body: dataBody);
    if (response.statusCode == 200) {
  ...
  getperiode() async {
    var response =  await http.get(Uri.parse('https://siakadtest.strada.ac.id/mobile/data/get_periode'),);
    if (response.statusCode == 200) {
