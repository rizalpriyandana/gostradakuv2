...
import 'package:gostradav2/app/data/models/getsks.dart';
import 'package:gostradav2/app/data/models/penawarankrs.dart';
...
class PenawaramKRSController extends GetxController {
  getmhs(String nim) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/data/penawaran_krs"),
        body: dataBody);
