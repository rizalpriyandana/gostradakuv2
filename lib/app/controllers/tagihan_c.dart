...
import 'package:gostradav2/app/data/models/bankmodel.dart';
import 'package:gostradav2/app/data/models/tagihan_m.dart';
...
class TagihanController extends GetxController {
  ...
  Tagihan(String nim) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/keuangan/tagihan"),
        body: dataBody);
  ...
  getcredit(nim) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/keuangan/select_credit"),
        body: dataBody);
  ...
  loadsemuatagihan(nim) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/keuangan/buat_tagihan"),
        body: dataBody);
  ...
  confirmtagihan(nim, id_biaya, id_credit, bayar) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/keuangan/save_tagihan"),
        body: dataBody);
  ...
  DataBank() async {
    var response = await http
        .get(Uri.parse("https://siakadtest.strada.ac.id/mobile/data/get_bank"));
  ...
  pengajuanceksemester(String nim) async {
    ...
    var response = await http.post(
        Uri.parse(
            "https://siakadtest.strada.ac.id/mobile/pengajuan_keringanan/get_semester"),
        body: dataBody);
  ...
  pengajuancek(String nim, String semester) async {
    ...
    var response = await http.post(
        Uri.parse(
            "https://siakadtest.strada.ac.id/mobile/pengajuan_keringanan/get_keringanan"),
        body: dataBody);
