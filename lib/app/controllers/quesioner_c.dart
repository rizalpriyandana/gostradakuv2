...
class QuesionerController extends GetxController {
  ...
  quesioner(String nim, String semester, String code_mk) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/edom/get_quisoner"),
        body: dataBody);
  ...
  inputjawabanmaster(
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/edom/save_quisoner"),
        body: dataBody);
  ...
  inputjawabandetail(
    ...
    var response = await http.post(
        Uri.parse(
            "https://siakadtest.strada.ac.id/mobile/edom/save_detail_quisoner"),
        body: dataBody);
