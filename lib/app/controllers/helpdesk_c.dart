...
import 'package:gostradav2/app/data/models/chat_k_m.dart';
import 'package:gostradav2/app/data/models/chat_m.dart';
...
class HelpdeskController extends GetxController {
  ...
  profilebar(String nim) async {
    ...
    var response = await http.post(
        Uri.parse(
            "https://siakadtest.strada.ac.id/mobile/skripsi/profile_pembimbing"),
        body: dataBody);
  ...
  void listchat(String nim) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/chat/get_msg"),
        body: dataBody);
  ...
  void listchatdosen(String nim, String id_admin) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/chat/get_msg_dosen"),
        body: dataBody);
  ...
  void listchatpegawai(String nim, String id_posisi) async {
    ...
    messageListpegawai.clear();
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/chat/get_msg_employee"),
        body: dataBody);
  ...
  void listchatdosenpembimbing(String nim, String id_dosen) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/skripsi/get_msg"),
        body: dataBody);
  ...
  inputchat(String nim, String pesan) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/chat/send_msg"),
        body: dataBody);
  ...
  inputchatpegawai(String nim, String id_posisi, String pesan) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/chat/send_employee_msg"),
        body: dataBody);
  ...
  inputchatdosen(String nim, String id_admin, String pesan) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/chat/send_dosen_msg"),
        body: dataBody);
  ...
  inputchatdosenpembimbing(
    ...
    var request = http.MultipartRequest('POST',
        Uri.parse('https://siakadtest.strada.ac.id/mobile/skripsi/send_msg'));
  ...
  readpesan(String nim) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/chat/read_msg"),
        body: dataBody);
  ...
  readpesandosen(String nim, String id_admin) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/chat/read_msg_dosen"),
        body: dataBody);
  ...
  readpesanpegawai(String nim, String id_posisi) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/chat/read_msg_employee"),
        body: dataBody);
  ...
  readpesandosenpembimbing(String nim, String id_dosen) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/skripsi/read_msg"),
        body: dataBody);
  ...
  listchathelpdesk() async {
    var response = await http
        .get(Uri.parse("https://siakadtest.strada.ac.id/mobile/chat/get_posisi"));
  ...
  listdosen(String nim, String id_posisi) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/chat/get_dosen"),
        body: dataBody);
  ...
  getbutton(
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/chat/get_button"),
        body: dataBody);
  ...
  getdosen(String nim, String type) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/chat/get_posisi"),
        body: dataBody);
  ...
  search(String nim, String query) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/chat/search_dosen"),
        body: dataBody);
  ...
  getchat(String nim) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/chat/get_inbox_msg"),
        body: dataBody);
  ...
  void listchatdiscuss(String nim, String id_pesan) async {
    ...
    nimSaya = nim;
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/skripsi/get_discuss"),
        body: dataBody);
  ...
  inputchatdiscuss(
    ...
    var request = http.MultipartRequest('POST',
        Uri.parse('https://siakadtest.strada.ac.id/mobile/skripsi/discuss'));
    request.fields.addAll(
  ...
  readpesandiscuss(String nim, String id_pesan) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/skripsi/read_discuss"),
        body: dataBody);
