...
import 'package:gostradav2/app/data/models/detailKhs_m.dart';
import 'package:gostradav2/app/data/models/masterkhs_m.dart';
import 'package:gostradav2/app/data/models/masterkrs_m.dart';
import 'package:gostradav2/app/data/models/transkipnilai_m.dart';
...
import 'package:gostradav2/app/ui/pages/kategori/riwayat_bayar/detailtransaksi/pdfview.dart';
...
class KrsController extends GetxController {
  ...
  final String masterKRS =
      'https://siakadtest.strada.ac.id/mobile/Data/master_krs';
  masterkrs(String nim) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/data/master_krs"),
        body: dataBody);
  ...
  detailkrs(String nim, String semester) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/data/detail_krs"),
        body: dataBody);
  ...
  masterkhs(String nim) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/data/master_khs"),
        body: dataBody);
  ...
  detailkhs(String nim, String semester) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/data/detail_khs"),
        body: dataBody);
  ...
  transkipnilai(String nim) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/data/transkip"),
        body: dataBody);
  ...
  Future downloadtranskip(
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/data/download_transkip"),
        body: dataBody);
  ...
  Future downloadkhs(Dio dio, String? nim, String? semester, String place,
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/data/download_khs"),
        body: dataBody);
  ...
  Future downloadkrs(Dio dio, String? nim, String? semester, String place,
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/data/download_krs"),
        body: dataBody);
