...
class SkripsiController extends GetxController {
  ...
  search(String query) async {
    ...
    var response = await http.post(
        Uri.parse(
            "https://siakadtest.strada.ac.id/mobile/skripsi/search_pembimbing"),
        body: dataBody);
  ...
  getdosenskripsi() async {
    var response = await http.get(Uri.parse(
        "https://siakadtest.strada.ac.id/mobile/skripsi/get_pembimbing"));
  ...
  sendpengajuan(String nim, String judul_1, String judul_2, String judul_3,
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/skripsi/ajukan_skripsi"),
        body: dataBody);
