...
import 'package:gostradav2/app/data/models/TPmodel.dart';
import 'package:gostradav2/app/data/models/nominal.dart';
...
class UploadBuktiController extends GetxController {
  ...
  UBB(String nim) async {
    ...
    var response = await http.post(
        Uri.parse(
            "https://siakadtest.strada.ac.id/mobile/keuangan/upload_bukti_bayar"),
        body: dataBody);
  ...
  GetTP(String nim) async {
    ...
    var response = await http.post(
        Uri.parse(
            "https://siakadtest.strada.ac.id/mobile/keuangan/get_tambah_pembayaran"),
        body: dataBody);
  ...
  getnominal(String code) async {
    ...
    var response = await http.post(
        Uri.parse(
            "https://siakadtest.strada.ac.id/mobile/keuangan/nominal_transaksi"),
        body: dataBody);
  ...
  postbukti(image, String nim, String idperiode, String CodeTransaksi,
    ...
    var request = http.MultipartRequest(
        'POST',
        Uri.parse(
            'https://siakadtest.strada.ac.id/mobile/keuangan/input_tagihan'));
  ...
  LihatBukti(String nim, String code) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/keuangan/lihat_bukti"),
        body: dataBody);
