...
import 'package:gostradav2/app/data/models/getipk.dart';
import 'package:gostradav2/app/data/models/pengumuman_m.dart';
...
class DashboardController extends GetxController {
  ...
  getipk(String nim) async {
    ...
    var response = await http.post(
        Uri.parse("https://siakadtest.strada.ac.id/mobile/dashboard/show_ipk"),
        body: dataBody);
  ...
  getpengumuman() async {
    var response = await http.get(
      Uri.parse(
          "https://siakadtest.strada.ac.id/mobile/pengumuman/get_pengumuman"),
    );
  ...
  getdetailpengumuman(String id_pengumuman) async {
    ...
    var response = await http.post(
        Uri.parse(
            "https://siakadtest.strada.ac.id/mobile/pengumuman/detail_pengumuman"),
        body: dataBody);
    if (response.statusCode == 200) {
      var databody = jsonDecode(response.body);
